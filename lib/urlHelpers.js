...
// 兼容 url-safe base64，并将字节按 UTF-8 还原为文本。
// atob 返回的是 Latin-1 风格的“字节字符串”；直接使用会让中文和 emoji 乱码。
export const decodeBase64Utf8 = (s) => {
...
export const b64decode = decodeBase64Utf8;
...
// 逗号分隔列表取首项（sing-box TLS alpn 仅保留第一个）
export const firstCsv = (s) => {
    const items = splitCsv(s);
